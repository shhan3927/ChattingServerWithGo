...
var SessionEDisconnect = errors.New("Sesson was disconnected!")
...
func (client *Client) ParseHeader() {
	header, payload, err := GetHeadAndPayload(client)
	if err != nil {
		return
	}
...
/////////////////////////////////////////
func GetHeadAndPayload(client *Client) (Header, []byte, error) {
	head := Header{}
